...
export default function EndPurchaseOrSale() {
  ...
  const endPurchase = () => {
    ...
    setBoughtStocks((prevState) => [...prevState,
      {
        stockCode: stockInfo[0].stockCode,
  ...
  return (
    <section className="flex justify-center">
      <div className="bg-end-operation-gray-lighter text-center text-end-operation-font-color-gray max-w-4xl mx-4 w-50 mt-10">
        ...
        <div className="py-10 pb-3 max-w-4xl text-black bg-end-operation-gray-darker">
